...
public class SignUpAssociationController implements Initializable {
    ...
    private void inscrit(ActionEvent event) throws IOException {
        ...
        if (fxemail.getText().isEmpty()
            ...
            alert.setTitle(" :: Error Message");
            alert.setHeaderText(null);
            alert.setContentText(" Le numéro de telephone doit contenir 8 chiffres !!");
            alert.showAndWait();
           ...
           Integer num_tel = Integer.parseInt(fxnum.getText());
            ...
            User p = new User(Email, nom, hashedPassword, adresse,num_tel,"association",activation_token, "inactif");
            us.ajouterUtilisateur2(p);
             ...
             // Configuration des propriétés SMTP session mail 
                ...
                String htmlBody = "<html>"
                        ...
                        + "<div class='card'>"
                        + "<h1>Bonjour " + nom + ",</h1>"
                        + "<p>Merci d'avoir choisi nos plateforme. Veuillez trouver ci-joint le code Confirmation d'inscription " + p.getActivation_token() + ".</p>"
